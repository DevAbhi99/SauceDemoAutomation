export class MainLocators{
    ...
    static lastNameLocator:string="//input[@id='last-name']";
    static postalCodeLocator:string="//input[@id='postal-code']";
    static continueBtnLocator:string="//input[@value='CONTINUE']";
    static finishBtnLocator:string="//a[text()='FINISH']";
}